...
- 6-значные начиная с 0/1/2/3/4/5/6/7/8 — основной формат ГОСТ (например 180205, 36209, 7305)
...
Как отличить систему запроса:
- Префикс NU/NJ/N/NF/NUP, цифры 22xxx/23xxx/30xxx/31xxx/32xxx (5 цифр), 16xxx, 51xxx–54xxx, 80xxx/81xxx → точно ISO.
- 6 цифр без буквенного префикса (180205, 36209, 466714) → точно ГОСТ.
- 4 цифры в диапазоне 6xxx/7xxx/8xxx → уточни у пользователя (двусмысленно).
- 4–5 цифр 6xxx без префикса (6205, 6311, 62307) → ISO.
...
📋 Аналоги (1–3 строки, в системе ПРОТИВОПОЛОЖНОЙ запросу)
| Аналог | Бренд | Размеры | Масса | Суффиксы | Применение | Примечание |

(если запрос в ISO — в колонке «Аналог» только ГОСТ-обозначения; если в ГОСТ — только ISO. Не дублируй варианты той же системы.)
